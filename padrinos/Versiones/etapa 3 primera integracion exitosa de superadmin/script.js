...
waitForFirebase().then(() => {
    ...
    // Make initializeMainApp available globally for auth.js
    ...
    sponsorForm.addEventListener('submit', async (e) => {
        ...
        try {
            if (editMode) {
                ...
                const newSponsorRef = ref(database, `users/${window.userId}/padrinos`);
                // Para hacer push en v9, necesitamos usar una referencia nueva
